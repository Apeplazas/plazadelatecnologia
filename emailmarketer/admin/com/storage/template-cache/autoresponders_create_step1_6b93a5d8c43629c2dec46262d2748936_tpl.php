<?php $IEM = $tpl->Get('IEM'); ?><form method="post" action="index.php?Page=Autoresponders&Action=Create&SubAction=Step2" onsubmit="return CheckForm();">
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		<tr>
			<td class="Heading1">
				<?php print GetLang('CreateAutoresponder'); ?>
			</td>
		</tr>
		<tr>
			<td class="body pageinfo">
				<p>
					<?php print GetLang('CreateAutoresponder_Step1_Intro'); ?>
				</p>
			</td>
		</tr>  
		<tr>
		...
		<tr>
			<td>
				...
				<input class="FormButton" type="button" value="<?php print GetLang('Cancel'); ?>" onClick='if(confirm("<?php print GetLang('Autoresponder_Step1_CancelPrompt'); ?>")) { document.location="index.php?Page=Autoresponders" }'>
				<br />
				&nbsp;
			...
			$tpl->TemplateData = $tmpTplData; ?>
				...
				<table width="100%" cellspacing="0" cellpadding="2" border="0" class="PanelPlain">
					<tr>
						...
						<td>
							<input class="FormButton" type="submit" value="<?php print GetLang('Next'); ?>" />
							<input class="FormButton" type="button" value="<?php print GetLang('Cancel'); ?>" onClick='if (confirm("<?php if(isset($GLOBALS['CancelButton'])) print $GLOBALS['CancelButton']; ?>")) { document.location="index.php?Page=Autoresponders" }' />
						</td>
					</tr>
				</table>
			</td>
