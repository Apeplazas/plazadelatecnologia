...
<form action="index.php?Page=<?php print $IEM['CurrentPage']; ?>&Action=<?php if(isset($GLOBALS['SubmitAction'])) print $GLOBALS['SubmitAction']; ?>" method="post" name="frmLogin" id="frmLogin" autocomplete="off">
	<div id="box" class="loginBox">
		...
		<table>
			...
			<td>
				...
				<tr>
					<td nowrap="nowrap" style="padding:0px 10px 0px 10px"><?php print GetLang('EnterPassword'); ?>:</td>
