...
<tr>
        <td class="FieldLabel">
			...
			$tpl->SetTemplate($tmpTplFile);
			$tpl->TemplateData = $tmpTplData; ?>
                <?php print GetLang('ApplyDefault'); ?>&nbsp;
        </td>
        <td>
                <label for="ApplyDefault"><input type="checkbox" id="ApplyDefault" name="ApplyDefault" <?php if(isset($GLOBALS['ApplyDefault'])) print $GLOBALS['ApplyDefault']; ?>><?php print GetLang('ApplyDefaultToExistingExplain'); ?></label>
        </td>
</tr>
<tr>
	<td width="200" class="FieldLabel">
