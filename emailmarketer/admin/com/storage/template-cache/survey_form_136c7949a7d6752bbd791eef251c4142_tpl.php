				...
				<div id="canvas">
					...
					<ul>
						<?php if($tpl->Get('widgetTemplates')): ?>
							<?php $array = $tpl->Get('widgetTemplates'); if(is_array($array) || is_object($array)): foreach($array as $__key=>$widgetTemplate): $tpl->Assign('__key', $__key, false); $tpl->Assign('widgetTemplate', $widgetTemplate, false);  ?>
