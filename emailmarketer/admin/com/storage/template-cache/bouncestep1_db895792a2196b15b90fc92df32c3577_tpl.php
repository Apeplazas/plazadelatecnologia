									...
									<td style="padding-top:5px;">
										<div class="ISSelect" style="width:300px;">
											<ul>
												...
												<?php $array = $tpl->Get('bounce_server_map'); if(is_array($array) || is_object($array)): foreach($array as $key=>$server): $tpl->Assign('key', $key, false); $tpl->Assign('server', $server, false);  ?>
														...
														<label for="server_<?php echo $tpl->Get('server','0','id'); ?>">
															...
															<?php else: ?>
																...
																<span class="Bounce_ISSelector_Description">
																	<?php if(!function_exists("foreach_27824")){ function foreach_27824(&$tpl, $array){ if(is_array($array) || is_object($array)): foreach($array as $__key=>$list): $tpl->Assign('__key', $__key, false); $tpl->Assign('list', $list, false);  ?>
																		<?php echo $tpl->Get('list','name'); ?><br />
																	 <?php endforeach; endif;}} foreach_27824($tpl, $tpl->Get('server')); ?>
																</span>
															<?php endif; ?>
														</label>
													</li>
