													...
													<div class="TriggerType_f_options TriggerType_options" <?php if($tpl->Get('record','triggertype') != 'f'): ?>style="display:none;"<?php endif; ?>>
														<div>
															...
															<select name="record[data][listid]" class="Field250">
																...
																<?php $array = $tpl->Get('availableLists'); if(is_array($array) || is_object($array)): foreach($array as $__key=>$each): $tpl->Assign('__key', $__key, false); $tpl->Assign('each', $each, false);  ?>
														...
														<div id="TriggerType_f_data_customfield" <?php if(!$tpl->Get('record','data','listid')): ?>style="display:none;"<?php endif; ?>>
															<?php ob_start(); ?>
																<?php $array = $tpl->Get('availableCustomFields'); if(is_array($array) || is_object($array)): foreach($array as $listid=>$customFieldLists): $tpl->Assign('listid', $listid, false); $tpl->Assign('customFieldLists', $customFieldLists, false);  ?>
																	<?php if($tpl->Get('record','data','listid') == $tpl->Get('listid')): ?>
																		<?php $array = $tpl->Get('customFieldLists','date'); if(is_array($array) || is_object($array)): foreach($array as $customFieldKey=>$customFieldRecord): $tpl->Assign('customFieldKey', $customFieldKey, false); $tpl->Assign('customFieldRecord', $customFieldRecord, false);  ?>
													...
													<div class="TriggerType_l_options TriggerType_options" <?php if($tpl->Get('record','triggertype') != 'l'): ?>style="display:none;"<?php endif; ?>>
														<div>
															...
															<select name="record[data][linkid_newsletterid]">
																...
																<?php $array = $tpl->Get('availableNewsletters'); if(is_array($array) || is_object($array)): foreach($array as $__key=>$each): $tpl->Assign('__key', $__key, false); $tpl->Assign('each', $each, false);  ?>
														...
														<div id="TriggerType_l_data_links" <?php if(!$tpl->Get('record','data','linkid_newsletterid')): ?>style="display:none;"<?php endif; ?>>
															<?php ob_start(); ?>
																<?php $array = $tpl->Get('availableLinks'); if(is_array($array) || is_object($array)): foreach($array as $newsletterid=>$linkList): $tpl->Assign('newsletterid', $newsletterid, false); $tpl->Assign('linkList', $linkList, false);  ?>
																	<?php if($tpl->Get('record','data','linkid_newsletterid') == $tpl->Get('newsletterid')): ?>
																		<?php $array = $tpl->Get('linkList'); if(is_array($array) || is_object($array)): foreach($array as $linkid=>$linkURL): $tpl->Assign('linkid', $linkid, false); $tpl->Assign('linkURL', $linkURL, false);  ?>
			...
			$tpl->TemplateData = $tmpTplData; ?>
									...
									<td>
										<select name="record[triggeractions][send][firstnamefield]" class="Field250">
											...
											<?php $array = $tpl->Get('availableNameCustomFields'); if(is_array($array) || is_object($array)): foreach($array as $__key=>$each): $tpl->Assign('__key', $__key, false); $tpl->Assign('each', $each, false);  ?>
