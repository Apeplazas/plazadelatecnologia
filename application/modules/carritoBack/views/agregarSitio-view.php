...
<form id="sitioEntrega" action="<?=base_url()?>carrito/formas_pago" method="post">
<? if (count($direcciones) > 0):?>
<p>Elige una dirección de tu lista.</p>
<ul id="listDir">
	<? foreach ($direcciones as $dir):?>
	<li><?=$dir->direccion?> <a href="<?=base_url()?>carrito/enviar_aqui/<?=$folio?>/<?=$dir->idSitio?>">enviar aquí</a></li>
	<? endforeach;?>
</ul>
<p>Nueva dirección.</p>
<? endif;?>
...
<script type="text/javascript">mixpanel.track("Agregado Direccion");</script>