...
<form action="<?=base_url()?>carrito/confirmaCarrito" method="post">
<ul id="proCar">
...
<li class="evTab">
	<div class="naDesCar">
		...
		<p><strong><?= $item[0]->ofertaTitulo;?></strong>
		<?= character_limiter($item[0]->ofertaDescripcion, 50);?></p>
	</div>
	<p class="desCan">
...
<script type="text/javascript">mixpanel.track("Agregados a Carrito");</script>
<script>
