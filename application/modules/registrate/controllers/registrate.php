...
');
	...
	function recuperar_hash()
	{
		...
		if ($u) {
			...
			$link_text="Hola $name !!! Da click aquí para generar su nueva contraseña <a href=\"http://www.plazadelatecnologia.com/registrate/ok/hash/$hash\">Recuperar Contraseña</a>";
