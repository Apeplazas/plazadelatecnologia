...
class Registrate_model extends CI_Model {
	...
	function validate($email, $contrasenia)
    {
        ...
        $query = $this->db->query("SELECT idRegistro,userAlias,email,registrationDate,schedule,gender FROM usuarios WHERE email=" . $this->db->escape($email) . " and contrasenia='$contraseniamd5'");
