...
class Computadoras extends MX_Controller {
...
Activity name of this tag: PT Computadoras
URL of the webpage where the tag is expected to be placed: http://www.apeplazas.com
This tag must be placed between the <body> and </body> tags, as close as possible to the opening tag.
Creation Date: 04/10/2015  toriz
-->
<script type="text/javascript">
var axel = Math.random() + "";
var a = axel * 10000000000000;
document.write(\'<iframe src="https://4808733.fls.doubleclick.net/activityi;src=4808733;type=invmedia;cat=itrmi59e;ord=\' + a + \'?" width="1" height="1" frameborder="0" style="display:none"></iframe>\');
</script>
<noscript>
<iframe src="https://4808733.fls.doubleclick.net/activityi;src=4808733;type=invmedia;cat=itrmi59e;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
</noscript>
