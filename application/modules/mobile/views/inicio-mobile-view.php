...
<div class="swiper-container">
	<div class="swiper-wrapper">
		<div class="swiper-slide">
            ...
            <a href="<?=base_url()?><?= $rowC->campaniaUrl;?>_mobile" class="camp"> <img src="<?=base_url()?>assets/graphics/mobile/<?= strtolower($rowC->campaniaNombre);?>-mobile.png" alt="<?= $rowC->campaniaDescripcion;?>" /></a>
            <? endforeach; ?>
