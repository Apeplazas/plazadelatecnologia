...
<article>
	...
	<p class="descArt"><span><a title="<?= $rowN->articuloTitulo;?>" href="<?=base_url()?>noticias/post/<?= $rowN->articuloUrl;?>"><img class="fleft"  src="<?=base_url()?>articulosUpload/<?= $rowN->articuloImagenes;?>" alt="<?= $rowN->articuloTitulo;?>" /></a></span> <?=  nl2br($rowN->articuloDescripcionPeque);?></p>
	<p class="descArt"><?= nl2br($rowN->articuloDescripcion);?></p>
	<? else:?>
	<p class="descArt"><span><a title="<?= $rowN->articuloTitulo;?>" href="<?=base_url()?>noticias/post/<?= $rowN->articuloUrl;?>"><img class="fleft"  src="<?=base_url()?>articulosUpload/<?= $rowN->articuloImagenes;?>" alt="<?= $rowN->articuloTitulo;?>" /></a></span><?=   nl2br($rowN->articuloDescripcion);?></p>
	<? endif;?>
	</div>
</article>
<div id="comArt">
