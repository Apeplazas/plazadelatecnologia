...
<fieldset>
  ...
  <input class="regIn required inMem" type="password" name="contrasenia" placeholder="Contraseña que deseas para el sistema">
</fieldset>
<fieldset>
  <input class="regIn required inMem" type="password" name="contrasenia" placeholder="Confirma la contraseña proporcionada">
</fieldset>
<fieldset>
  <?= form_error('plaza'); ?>
