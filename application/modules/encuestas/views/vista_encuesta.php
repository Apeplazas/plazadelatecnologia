<div id="encuestasPlazas">
 <span id="encuestalogo"><img src="<?=base_url()?>assets/graphics/logo-encuestas.jpg" alt="Encuestas Plaza de la Tecnologia" /></span>
	<div id="wrapEncu">
	<ul>
	    ...
	    <input type="hidden" value="<?=$this->session->userdata('usuarioID');?>" name="usuarioID" />
