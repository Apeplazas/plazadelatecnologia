...
<style>
body{font-family: 'Raleway', sans-serif; font-size:.9em;}
...
color: #fff;
font-size: .9em;}
strong {text-transform: uppercase; font-size: .9em; font-weight: normal; }
p {text-transform: lowercase; font-size: .9em;}
</style>
...
<table width="670" border="0" align="center" cellspacing="0">
  ...
  <tr>
    ...
    <?php if ($rowMail->mailTipoUrl!="si"): ?>
    	<img src="<?=base_url();?>assets/graphics/mailing-graphics/<?=$rowMail->mailImagen;?>" width="670">
        <?php elseif ($rowMail->mailTipoUrl=="si"): ?>
        <a href="<?=$rowMail->mailUrl;?>"><img src="<?=base_url();?>assets/graphics/mailing-graphics/<?=$rowMail->mailImagen;?>" width="670">
        </a>
        <?php endif; ?>
    </td>
  </tr>
  <?php endforeach;?>
  <tr>
    <td colspan="2"><img src="<?=base_url();?>assets/graphics/mailing-graphics/grandesOfertas.jpg"></td>
  </tr>
  <tr>
    <td class="ofertasEsp"><table width="100%" border="0" cellspacing="0">
      <tr>
      	<?php foreach ($ofertasEsp as $rowOfertaEsp) :?>
        <td width="223" align="left" valign="top">
        	<blockquote>
        	  <strong><?=$rowOfertaEsp->tituloOferta;?></strong><br /><br />
        	  <a href="<?=base_url();?><?=$rowOfertaEsp->ofertaCategoria;?>/oferta/<?=url_title($rowOfertaEsp->tituloOferta,"_");?>/<?=$rowOfertaEsp->ofertaID;?>"><img src="<?=base_url();?>ofertasLocatarios/<?=str_replace(".", "_thumb.", $rowOfertaEsp->imagenOferta);?>"/></a>
        	  <br />
        	  <br />
        	  <a href="<?=base_url();?><?=$rowOfertaEsp->ofertaCategoria;?>/oferta/<?=url_title($rowOfertaEsp->tituloOferta,"_");?>/<?=$rowOfertaEsp->ofertaID;?>"><img src="<?=base_url();?>assets/graphics/mailing-graphics/verOfertaMain.png"></a>
      	  </blockquote>
        </td>
        <?php endforeach;?>
      </tr>
  ...
  <?php $as = $this->boletin_model->cargarOfertasCat($rowCat->ramaUrl);?>
  <?php if(!empty($as)):?>
  <tr>
