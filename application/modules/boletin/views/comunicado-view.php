...
a {color: #BD2327; text-decoration: none; cursor: pointer; font-size:.9em; }
...
<table width="670" border="0" align="center" cellspacing="0">
  ...
  <tr>
    <td colspan="2">
    <?php if ($rowMail->tipoUrl!="si"): ?>
    	<img src="<?=base_url();?>assets/graphics/mailing-graphics/<?=$rowMail->Imagen;?>">
        <?php elseif ($rowMail->tipoUrl=="si"): ?>
        <a href="<?=$rowMail->comunicadoUrl;?>"><img src="<?=base_url();?>assets/graphics/mailing-graphics/<?=$rowMail->Imagen;?>">
        </a>
        <?php endif; ?>
    </td>
  </tr>
