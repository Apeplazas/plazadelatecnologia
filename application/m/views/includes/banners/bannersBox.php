...
<a id="boxBanner" href="<?= $rowBox->bannerUrl;?>" target="_blank" title="<?= $rowBox->bannerTitulo;?>"><img src="<?=base_url()?>assets/graphics/bannerPublicidad/<?= $rowBox->imagen;?>" alt="<?= $rowBox->bannerTitulo;?>" /></a>
<?php endforeach; ?>
<?php endif; ?>
