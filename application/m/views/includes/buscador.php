<div id="busquedas">
<form id="formBuscar" action="<?=base_url()?>busqueda_rapida" method="post" >
  <fieldset>
    ...
    <input class="inputReg" id="bckBuscar" placeholder="Ejemplo: Tablets" type="text" name="key">
    <input  id="buscar" type="submit"  value="Buscar" title="Buscar" >
    <input type="hidden" value="" id="avanzada" />
  </fieldset>
</form>
</div>
<script>
