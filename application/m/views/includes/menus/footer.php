...
<section id="specialForms">
	...
	<img src="<?=base_url()?>assets/graphics/plazadelatecnologia-marketplace.png" alt="Plaza de la Tecnología Market Place" />
		...
		<iframe src="//www.facebook.com/plugins/like.php?href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;width=200&amp;layout=button_count&amp;action=like&amp;show_faces=false&amp;share=false&amp;height=21&amp;appId=440098306072057" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:180px; height:21px;" allowTransparency="true"></iframe>
		</div>
...
<div id="grayFoot">
	...
	<dl id="metPago">
	 ...
	 <dl id="importante">
	 	...
	 	<dd><a title="Siguenos en Facebook" href="https://www.facebook.com/plazadelatecnologia">Facebook</a></dd>
	 	<dd><a title="Siguenos en Twitter" href="http://twitter.com/plazatecnologia">Twitter</a></dd>
	 	<dd><a title="Siguenos en Google Plus" href="https://plus.google.com/+plazadelatecnologia">Google plus</a></dd>
	 </dl>
