<aside id="barRight">
	...
	<ul id="notDes">
		...
		<li><a href="<?=base_url()?>noticias/post/<?= $rowD->articuloUrl;?>" title="<?=$rowD->articuloTitulo?>"><img src="<?=base_url()?>articulosUpload/<?= $rowD->imagenesThumbs;?>" alt="<?=$rowD->articuloTitulo?>" /><em><?= character_limiter($rowD->articuloTitulo,'26');?> </em></a></li>
		<? endforeach; ?>
	</ul>
</aside>