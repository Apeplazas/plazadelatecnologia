...
<fieldset>
  <textarea id="dirMem" name="comentarioContacto" placeholder="Escribe aquí tu pregunta o comentario" class="regIn required" value=""></textarea>
</fieldset>
<fieldset>
	<p class="aviso"><input name="privacidad" checked="" type="checkbox" value="Leido">
	He leido el <a style="color: #c30;" href="http://m.plazadelatecnologia.com/avisoPrivacidad" target="new">aviso de privacidad</a></p>
	</fieldset>
<fieldset>
<fieldset>
