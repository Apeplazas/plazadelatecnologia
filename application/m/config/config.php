...
|
*/
$config['base_url']	= "http://www.plazadelatecnologia.com";
...
|--------------------------------------------------------------------------
|
| Check and see if our site is installed.
| DO NOT EDIT BELOW!!!
|
| $config['site_installed'] = TRUE; // site is installed
| $config['site_installed'] = FALSE; // site is not installed
*/
